...
namespace wideweb\socialmediaposts\fields;

use wideweb\socialmediaposts\SocialMediaPosts;
use wideweb\socialmediaposts\assetbundles\socialmediapostsfieldfield\SocialMediaPostsFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class SocialMediaPostsField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('social-media-posts', 'SocialMediaPostsField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'social-media-posts/_components/fields/SocialMediaPostsField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(SocialMediaPostsFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SocialMediaPostsSocialMediaPostsField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'social-media-posts/_components/fields/SocialMediaPostsField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
